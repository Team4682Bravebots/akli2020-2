...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    st = new Shooter(6);
    ibl = new Intake(7);
    CSM_C = new CANSparkMax(3, MotorType.kBrushless);
    pid = new Position(CSM_C);
    carousel = new Carousel(pid);
  ...
  public void teleopPeriodic() {
    ...
    if(cfa <= 0.1 && cfa >= -0.1 || cfc <= 0.1 && cfc >= -0.1)
    {   
      ...
      _talon0.set(ControlMode.PercentOutput, cfa);
      _talon0.set(ControlMode.PercentOutput, cfc);
    }
    irs.sendtome();
